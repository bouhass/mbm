	...
	<g:form action='userSearch' name='userSearchForm'>
		...
		<table>
            ...
            <tr>
                ...
                <td colspan='3'><g:textField name='name' size='50' maxlength='255' autocomplete='off' value='${name}'/></td>
            </tr>
			<tr>
...
<%
def queryParams = [name: name, username: username, enabled: enabled, accountExpired: accountExpired, accountLocked: accountLocked, passwordExpired: passwordExpired]
%>
